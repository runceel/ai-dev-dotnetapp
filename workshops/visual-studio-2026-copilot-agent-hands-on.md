...
| 満席表示 | 残り枠数が 0 の場合に表示する |
| キャンセル待ち表示 | `RegistrationStatus.WaitListed` が 1 件以上ある場合に表示する |

この変更では、既存の画面、UseCase、Repository、bUnit テストを Agent に調べさせながら進めます。新しいプロジェクトや大きな抽象化を追加する必要はありません。
