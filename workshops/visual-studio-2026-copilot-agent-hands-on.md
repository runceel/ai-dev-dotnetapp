...
| ステップ | 内容 | 目安 |
|------|------|------|
| 1 | Agent に既存コードを調査させる | 5 分 |
| 2 | 実装計画だけを作らせる | 5 分 |
| 3 | 計画を確認し、必要なら小さく調整する | 3 分 |
| 4 | Agent に実装とテスト更新を依頼する | 9 分 |
| 5 | ビルド、テスト、画面表示を確認する | 5 分 |
| 6 | レビュー向け説明を作らせる | 3 分 |

時間が足りない場合は、画面表示の確認を省略し、ビルドとテストの確認までを最低限のゴールにします。
...
最小構成では、次の 2 つだけを実装できれば十分です。

- 参加確定者数
- 残り枠数

満席表示とキャンセル待ち表示は、後から追加する課題として扱えます。
