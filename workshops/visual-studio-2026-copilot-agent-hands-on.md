...
| 2 | 実装計画を作らせ、必要なら小さく調整する | 必須 |
| 3 | Agent に実装とテスト更新を依頼する | 必須 |
| 4 | ビルドとテストを確認する | 必須 |
| 5 | 画面表示を目視確認する | 任意 |
| 6 | レビュー向け説明を作らせる | 任意 |

必要に応じてステップ 5〜6 を後回しにし、ステップ 4（ビルドとテストの確認）の完了を最低限のゴールとして扱ってください。
